	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
		...
		(s.burstSamples ?? []).length > 0 && (() => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				}), bursts.map((b, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
function insightPreview(insight, s) {
	switch (insight.id) {
		...
		case "night-cost": return `${new Date(s.hourHistogram.indexOf(Math.max(...s.hourHistogram.slice(0, 6))) * 36e5).toISOString().slice(11, 16)} 时段`;
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							children: typeof cost === "number" && typeof report?.budget === "number" && report.budget > 0 ? `¥${cost.toFixed(2)} / ¥${report.budget.toFixed(2)}` : "设置预算"
						})
					})
				]
			}),
			...
			report !== null && s !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				insights.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					"data-whale-report-h2": true,
					children: "值得注意"

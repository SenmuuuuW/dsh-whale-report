...
function ReportView({ report, onDelete }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
		...
		(s.sessionsDetail ?? []).length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SessionDrilldown, { sessions: s.sessionsDetail ?? [] }),
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			report !== null && s !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				(() => {
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(WhaleFace, {
							mood: whaleMood(report),
							size: 30
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: "本期鲸评" }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
							"“",
							NOTE_TEMPLATES[kinds[0]].light,
							"”"
						] })] })]
					});
				})(),
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					"data-whale-report-h2": true,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SonarIcon, {}), "活跃"]
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					"data-whale-report-card": true,
				...
				(s.sessionsDetail ?? []).length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					"data-whale-report-h2": true,
					children: "会话钻取"
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SessionDrilldown, { sessions: (s.sessionsDetail ?? []).slice(0, 5) })] }),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					"data-whale-report-btn": true,
...
function exportReportImage(report) {
	...
	height += 40 + rowH(40) + rowH(13);
	height += section("活跃") + 24 * 4 + 20;
	...
	const title = (text$1, size, color, dy = 0) => {
		ctx.fillStyle = color;
		ctx.font = `700 ${size}px "PingFang SC", sans-serif`;
		ctx.fillText(ellipsis(text$1, maxText, size), padding, y + size + dy);
		y += rowH(size);
	};
	const text = (text$1, size, color) => {
		ctx.fillStyle = color;
		ctx.font = `400 ${size}px "PingFang SC", sans-serif`;
		ctx.fillText(ellipsis(text$1, maxText, size), padding, y + size);
		y += rowH(size);
	};
	const sep = () => {
		y += 8;
	...
	sep();
	title("会话钻取", 14, navy);
	for (const sd of sessions.slice(0, 5)) text(`${sd.title || "（未命名会话）"}  ¥${sd.cost.toFixed(2)}`, 12, navy);
	sep();
	title("危险操作", 14, navy);
	if (s.dangerousCommands.length === 0) text("无", 12, gray);
	else for (const d of s.dangerousCommands.slice(0, 5)) text(`• ${d.command.replace(/\s+/g, " ").slice(0, 44)}`, 12, "#b91c1c");
	y += 10;
...
function triggerNotes(report) {
	const s = report.stats;
	const hits = [];
	if ((s.dangerousCommands ?? []).some((d) => d.sev === "red")) hits.push({
		kind: "danger",
		weight: 0
	});
	else if (s.dangerousCommands.length > 0) hits.push({
		kind: "danger",
		weight: 1
	});
	if (typeof report.cost?.total === "number" && typeof report.budget === "number" && report.budget > 0) {
		...
		if (ratio >= 1) hits.push({
			kind: "budget",
			weight: 0
		});
		else if (ratio >= .8) hits.push({
			kind: "budget",
			weight: 2
		});
	}
	if ((s.retryBursts ?? 0) >= 3) hits.push({
		kind: "retry",
		weight: 2
	});
	const night = s.totalEvents === 0 ? 0 : Math.round(s.hourHistogram.slice(0, 6).reduce((a, b) => a + b, 0) / s.totalEvents * 100);
	if (night >= 15) hits.push({
		kind: "night",
		weight: 3
	});
	if (s.sessions >= 5 && s.sessions > 0 && s.turns / s.sessions < 2) hits.push({
		kind: "fragment",
		weight: 4
	});
		...
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(WhaleFace, {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: "本期鲸评" }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
			...
			top !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				"data-whale-report-noteline": true,
				children: [
					"“",
					NOTE_TEMPLATES[top][mode],
					"”"
				]
			}),
			kinds.slice(1, 3).map((kind) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				"data-whale-report-notemore": true,
				children: ["· ", NOTE_TEMPLATES[kind][mode]]
			}, kind)),
			kinds.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				"data-whale-report-noteline": true,
				children: "“本周数据很健康，继续保持就好啦。”"
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
function SessionDrilldown({ sessions }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			"data-whale-report-h2": true,
			children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SonarIcon, {}),
				"会话钻取（",
				sessions.length,
				"）"
			]
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: s.title || "（未命名会话）" }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
						...
						s.toolCalls > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("em", {
							"data-whale-report-badge-gray": true,
							children: [s.toolCalls, " 工具"]
						})
					] })]
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					"data-whale-report-sessioncost": true,
					children: ["¥", s.cost.toFixed(2)]
				})]

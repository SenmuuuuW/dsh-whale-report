...
const SHANGHAI_OFFSET_MS = 8 * 60 * 60 * 1e3;
...
const THEME_STORAGE_KEY = "whale.theme";
const THEME_CHOICES = [
	"system",
	"light",
	"dark"
...
*/
function resolveTheme(choice, hostTheme, prefersDark) {
...
function parseStoredChoice(raw) {
...
*/
function hostThemeOf(styleColorScheme, dataset) {
...
var ThemeRuntime = class {
	...
	apply() {
		...
		this.deps.setRootTheme(this.resolved);
		if (this.choice === "system" && this.listeners.size > 0 && this.unsubscribeMedia === null) this.attachMedia();
		else if (this.choice !== "system") this.detachMedia();
...
const abortControllerOf = () => new AbortController();
/** 带超时预算的 fetch：超时 → 以 AbortError 拒绝；支持外部 signal（竞态取消旧请求）。 */
async function fetchWithTimeout(url, init, timeoutMs, extraSignal) {
...
function describeFetchError(error, timeoutMs) {
	if (isAbortError(error)) return `请求超时（${Math.round(timeoutMs / 1e3)} 秒无响应）`;
...
function useResolvedTheme() {
	...
	return (0, react.useSyncExternalStore)(rt.subscribe.bind(rt), rt.getResolved.bind(rt));
}
/** 组件侧读取用户选择（theme toggle 高亮用）。 */
function useThemeChoice() {
	const rt = themeRuntime;
	if (rt === null) return "system";
	return (0, react.useSyncExternalStore)(rt.subscribe.bind(rt), rt.getChoice.bind(rt));
}
...
function ThemeIcon({ choice }) {
	if (choice === "light") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		viewBox: "0 0 16 16",
		fill: "none",
		"aria-hidden": "true",
	...
	if (choice === "dark") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
		viewBox: "0 0 16 16",
		fill: "none",
		"aria-hidden": "true",
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
				d: "M8 1.5v1.2M8 13.3v1.2M1.5 8h1.2M13.3 8h1.2",
				stroke: "currentColor",
				strokeWidth: "1.4",
				strokeLinecap: "round"
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
				d: "M11.6 4.4a4.6 4.6 0 1 1-6 6 4.6 4.6 0 0 0 6-6Z",
				fill: "currentColor",
				fillOpacity: ".9"
			})
		]
...
function ThemeToggle() {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		"data-whale-report-theme": true,
		role: "group",
		"aria-label": "主题切换（跟随系统 / 浅色 / 深色）",
		children: THEME_CHOICES.map((c) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
			type: "button",
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ThemeIcon, { choice: c })
		}, c))
	});
}
const CSS = `
...
function PartialBanner({ partial }) {
	if (partial === void 0 || partial.skippedCount <= 0 && partial.salvage === void 0) return null;
	const shown = partial.skippedSessionIds.slice(0, 4);
	const sv = partial.salvage;
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		"data-whale-report-partial": true,
		role: "note",
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			"data-whale-report-partialmark": true,
			children: "DATA PARTIAL"
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
			partial.skippedCount > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: partial.skippedCount }),
				" 个会话日志损坏/无法读取，已跳过",
				shown.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
					" ",
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", { children: shown.join(" · ") }),
					shown.length < partial.skippedCount && ` +${partial.skippedCount - shown.length}`
				] }),
				"。",
				" "
			] }),
			sv !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [sv.droppedRecords > 0 ? `${sv.recoveredSessions} 个会话尾部损坏。已恢复 ${sv.recoveredRecords} 条完整记录，${sv.droppedRecords} 条残缺记录未计入。` : `${sv.recoveredSessions} 个会话的全部 ${sv.recoveredRecords} 条记录已只读恢复（0 条丢弃）。`, " "] }),
			partial.skippedCount > 0 || sv !== void 0 && sv.droppedRecords > 0 ? "缺失数据不按 0 计。" : "数据已完整恢复。"
		] })]
	});
}
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						[
							...
							style: { background: ACTIVITY_LEVEL_COLORS[theme][l] },
...
function TokenBar({ tokens }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", { style: { background: legend[0] } }),
				"输入 ",
				fmt(tokens.input)
			] }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", { style: { background: legend[1] } }),
				"输出 ",
				fmt(tokens.output)
			] }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", { style: { background: legend[2] } }),
				"缓存 ",
				fmt(tokens.cacheRead)
			] }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", { style: { background: legend[3] } }),
				"思考 ",
		...
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(PartialBanner, { partial: s.partial })
				]
			}),
...
const SNAPSHOT_FRESH_MS = 5 * 60 * 1e3;
const SNAPSHOT_STALE_NOTICE_MS = 15 * 60 * 1e3;
...
var WhaleContent = class extends react.Component {
	...
	overviewTimer;
	componentDidMount() {
		this.refreshOverview(this.state.preset);
		this.overviewTimer = window.setInterval(() => {
			this.pollOverview(this.state.preset);
		}, 6e4);
	}
	componentWillUnmount() {
		if (this.overviewTimer !== void 0) window.clearInterval(this.overviewTimer);
	}
	setToast(message) {
	...
	*/
	async refreshOverview(preset) {
		...
		try {
			const payload = preset === "custom" ? `&from=${encodeURIComponent(this.state.from)}&to=${encodeURIComponent(this.state.to)}` : "";
			const response = await fetchWithTimeout(`/whale/api/overview?preset=${encodeURIComponent(preset)}${payload}`, {}, FETCH_TIMEOUT_MS.overview, this.requestAbort.signal);
			const body = await response.json();
			if (!response.ok || body.ok === false) throw new Error("overview 读取失败");
			if (seq !== this.requestSeq) return;
			if (body.report === void 0) throw new Error("overview 无数据");
			...
			this.setState({
				loading: false,
				error: describeFetchError(error, FETCH_TIMEOUT_MS.overview)
			});
		} finally {
	...
	async pollOverview(preset) {
		try {
			const response = await fetchWithTimeout(`/whale/api/overview?preset=${encodeURIComponent(preset)}`, {}, FETCH_TIMEOUT_MS.overview);
			const body = await response.json();
			if (!response.ok || body.ok === false || body.snapshot !== true || body.report === void 0) return;
			if (body.lastUpdated !== null && (this.state.snapshotAt === null || body.lastUpdated > this.state.snapshotAt)) this.setState({
				dashboard: body.report,
				current: body.report,
				snapshotMode: false,
				snapshotAt: body.lastUpdated,
				indexing: body.indexing === true
			});
		} catch {}
	}
	...
	* v0.5.2：background 后台刷新（快照保留显示）；成功后切换为完整数据并更新时间戳。 */
	async loadDashboard(preset, opts) {
		const seq = ++this.requestSeq;
		if (this.requestAbort !== null) this.requestAbort.abort();
		this.requestAbort = new AbortController();
		this.setState({
		...
		try {
			...
			const response = await fetchWithTimeout("/whale/api/summary", {
				method: "POST",
				headers: { "content-type": "application/json" },
				body: JSON.stringify(payload)
			}, FETCH_TIMEOUT_MS.summary, this.requestAbort.signal);
			const body = await response.json();
			...
			this.setState({
				loading: false,
				error: describeFetchError(error, FETCH_TIMEOUT_MS.summary)
			});
		} finally {
			if (seq === this.requestSeq) this.setState({ loading: false });
		}
	...
	async openHistory(id) {
		...
		try {
			const response = await fetchWithTimeout(`/whale/api/get?id=${encodeURIComponent(id)}`, {}, FETCH_TIMEOUT_MS.report, this.requestAbort.signal);
		...
		children: [
			...
			hover !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(hover.skippedCount ?? 0) > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
						"该周期 ",
						hover.skippedCount,
						" 个会话损坏被跳过 · 数字低于实际"
					] }),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: ["Tokens ", /* @__PURE__ */ (0, react_jsx_runtime.jsx)("em", { children: fmt(usageTotalTokens(hover.tokens)) })] }),
...
function TrendSection({ preset }) {
	...
	(0, react.useEffect)(() => {
		...
		setTrends(null);
		setHoverIndex(null);
		fetchWithTimeout(`/whale/api/trends?preset=${encodeURIComponent(preset)}&limit=8`, {}, FETCH_TIMEOUT_MS.light).then((r) => r.ok ? r.json() : Promise.reject(new Error("HTTP"))).then((json) => {
...
function cstDayOfWeek(ms) {
	return new Date(ms + 8 * 36e5).getUTCDay();
}
...
function PricePeriodCard() {
	...
	const next = weekend ? (() => {
		const sh = new Date(now.getTime() + 8 * 36e5);
		const dayStartUtc = Date.UTC(sh.getUTCFullYear(), sh.getUTCMonth(), sh.getUTCDate());
		const daysAhead = dow === 6 ? 2 : 1;
		return {
			m: 9 * 60,
			label: "周一 9:00",
			to: "peak",
			atMs: dayStartUtc + daysAhead * 864e5 + 9 * 36e5 - 8 * 36e5
		};
	})() : null;
	const weekdayNext = next === null ? PERIOD_BOUNDS.find((b) => b.m > cstClock) ?? {
		m: 33 * 60,
		label: "9:00",
		to: "peak"
	} : next;
	const minutesLeft = next === null ? weekdayNext.m - cstClock : Math.ceil((next.atMs - now.getTime()) / 6e4);
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					next === null ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						"距 ",
						weekdayNext.label,
						" 转",
						weekdayNext.to === "peak" ? "高峰" : "谷时",
						" ",
						countdown
					] }) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						"周末全天谷时 · 距 ",
...
function LiveSessionCard() {
	...
	const load = () => {
		fetchWithTimeout("/whale/api/live-session", {}, FETCH_TIMEOUT_MS.light).then((r) => r.ok ? r.json() : Promise.reject(new Error("HTTP"))).then((json) => {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
					...
					liveTime,
					" · 30s AUTO REFRESH"
				] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "快照后仍在发生的实时活动" })]
			})
		]
	});
}
...
function ProviderBalanceCard() {
	...
	const load = (refresh, silent = false) => {
		...
		fetchWithTimeout(`/whale/api/balance${refresh ? "?refresh=1" : ""}`, {}, FETCH_TIMEOUT_MS.balance).then((r) => r.ok ? r.json() : Promise.reject(new Error(`HTTP ${r.status}`))).then((json) => setData(json.balance)).catch((error) => setData({
			provider: "deepseek",
			name: "DeepSeek",
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			data === null ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				"data-whale-report-balancebreak": true,
				children: data.status === "invalid-key" ? "余额不可用，本期费用仍按本地事件估算。" : `${BALANCE_STATUS_LABEL[data.status]}，本期费用仍按本地事件估算。`
			})] }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
function Dashboard(props) {
	...
	const report = dashboard !== null && dashboard.preset === preset ? preset === "custom" && Date.parse(from) === dashboard.from && Date.parse(to) === dashboard.to ? dashboard : preset !== "custom" ? dashboard : null : null;
	const s = report?.stats;
	...
	const totalTokens = s !== void 0 ? usageTotalTokens(s.tokens) : 0;
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			!loading && error !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				"data-whale-report-refresherr": true,
				role: "alert",
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", {}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: report !== null ? "REFRESH FAILED · 保留上次数据" : "REFRESH FAILED" }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: error }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						"data-whale-report-retry": true,
						onClick: onRetry,
						children: "重试"
					})
				]
			...
			!loading && report === null && error === null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				"data-whale-report-loading": true,
			...
			report !== null && s !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				snapshotAt !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					"data-whale-report-snapmeta": true,
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							"data-whale-report-snaplabel": true,
							children: "LAST UPDATED"
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							"data-whale-report-snaptime": true,
							children: new Date(snapshotAt).toLocaleTimeString("zh-CN", { hour12: false })
						}),
						indexing ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							"data-whale-report-snapnote": true,
							children: "INDEXING LIVE DATA…（数据截至已索引事件）"
						}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							"data-whale-report-snapnote": true,
							children: "完整统计（含进行中会话，截至 LAST UPDATED 时刻）"
						}),
						staleNotice && !indexing && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							"data-whale-report-snapstale": true,
							children: "数据较旧"
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							"data-whale-report-refresh": true,
							disabled: loading,
							onClick: onRefresh,
							children: loading ? "更新中…" : "刷新"
						})
					]
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(TrendSection, { preset }),
				(report.improvements ?? []).length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ImproveSection, { items: report.improvements ?? [] }),
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
					"data-whale-report-details": true,
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("summary", { children: "更多详情：活跃扫描 / 模型分配 / 会话轨迹" }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
							"data-whale-report-section": true,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SectionHeader, {
								index: "03",
...
function ApplyFlow({ item }) {
	...
	const review = async () => {
		...
		setMsg(null);
		try {
			const body = await api("apply/proposals", { improvementId: item.id });
	...
	const pollVerify = (applyId) => {
		const poll = async () => {
			try {
				const v = await api(`verify/${applyId}`);
				setVerify(v);
		...
		poll();
		timerRef.current = window.setInterval(() => void poll(), 1e4);
	};
	const apply$1 = async () => {
		...
		setMsg(null);
		try {
			const body = await api(`apply/${proposal.id}/approve`, { applyId: `${proposal.id}::${nonce}` });
	...
	const fmtMs = (ms) => ms >= 6e4 ? `${Math.round(ms / 1e3 / 60)}min` : `${Math.round(ms / 1e3)}s`;
	if (phase === "idle") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		"data-whale-report-applybtn": true,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
			onClick: () => void review(),
	...
	if (phase === "error") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		"data-whale-report-applyerr": true,
		children: msg ?? "未知错误"
	}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		"data-whale-report-applybtn": true,
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
	...
	if (phase === "ready" && proposal !== null) {
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			"data-whale-report-apply": true,
			children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					"data-whale-report-applyrow": true,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "PROBLEM" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: proposal.reason })]
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					"data-whale-report-applyrow": true,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "EVIDENCE" }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
						proposal.evidence.timeoutCount,
						" 次确定性 timeout · ",
						proposal.evidence.timeoutSessions.length,
						" 个会话 ·",
						" ",
						proposal.evidence.shellInvocationCount,
						" 次 shell 调用"
					] })]
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					"data-whale-report-applyrow": true,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "CHANGE" }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
						"shell.timeoutMs ",
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: fmtMs(proposal.expectedBefore) }),
						" → ",
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: fmtMs(proposal.proposedAfter) })
					] })]
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					"data-whale-report-applyrow": true,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "EXPECTED" }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
						"shell_timeout_rate ≤ ",
						pct(proposal.verificationPlan.target.value),
						"（样本 ≥",
						proposal.verificationPlan.minimumEvidence.observations,
						" 次调用 / ≥",
						proposal.verificationPlan.minimumEvidence.sessions,
						" 会话）"
					] })]
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					"data-whale-report-applyrow": true,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "ROLLBACK" }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
						"一键还原为 ",
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: fmtMs(proposal.rollbackPlan.value) }),
						"（并发安全）"
					] })]
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
	...
	const chip = vStatus === "reverted" ? "REVERTED" : vStatus === "verified" ? "VERIFIED" : vStatus === "not_improved" ? "NOT IMPROVED" : vStatus === "inconclusive" ? "INCONCLUSIVE" : "OBSERVING";
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		"data-whale-report-apply": true,
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				"data-whale-report-applyrow": true,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "STATUS" }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					"data-whale-report-applychip": true,
					"data-status": vStatus,
					children: chip
				}), verify !== null && verify.record.observed !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
					" · shell_timeout_rate ",
					(verify.record.observed.value ?? 0) * 100 > 0 ? `${((verify.record.observed.value ?? 0) * 100).toFixed(2)}%` : "—",
					" · 样本 ",
					verify.progress.observations,
					"/",
					verify.record.minimumEvidence?.observations ?? "?"
				] })] })]
			}),
			verify?.verdictNote !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				"data-whale-report-applyrow": true,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "VERIFY" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: verify.verdictNote })]
			}),
			verify?.record.observed !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				"data-whale-report-applyrow": true,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "OBSERVED" }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
					"基线 ",
					(verify?.record.baseline?.value ?? 0) * 100 > 0 ? `${((verify?.record.baseline?.value ?? 0) * 100).toFixed(2)}%` : "—",
					" → 观察 ",
					(verify?.record.observed?.value ?? 0) * 100 > 0 ? `${((verify?.record.observed?.value ?? 0) * 100).toFixed(2)}%` : "—",
					"（目标 ≤",
					((verify?.record.targetValue ?? 0) * 100).toFixed(2),
					"%）"
				] })]
			}),
			(vStatus === "not_improved" || vStatus === "inconclusive") && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				"data-whale-report-applybtn": true,
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					"data-danger": true,
					onClick: () => void revert(),
					children: "Revert（恢复原值）"
				})
			})
		]
	});
...
function ImproveSection({ items }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SectionHeader, {
			index: "01",
			title: "值得改进",
			meta: `IMPROVE / TOP ${top.length}${items.length > top.length ? ` · +${items.length - top.length} 条` : ""}`
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			"data-whale-report-improvelist": true,
			children: top.map((it, index) => {
				const open = openId === it.id;
				const metrics = Object.entries(it.evidence.metrics).filter(([key]) => IMPROVE_METRIC_LABEL[key] !== void 0).map(([key, value]) => ({
					key,
					label: IMPROVE_METRIC_LABEL[key],
					value
				}));
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					"data-whale-report-improveitem": true,
					"data-severity": it.severity,
					"data-open": open,
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							"data-whale-report-improvehead": true,
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									"data-whale-report-improveindex": true,
									children: String(index + 1).padStart(2, "0")
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("em", {
									"data-whale-report-improvesev": true,
									children: it.severity
								}),
								it.evidence.experimental === true && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", {
									"data-whale-report-improveexp": true,
									children: "EXPERIMENTAL"
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: it.title }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									"data-whale-report-improvetoggle": true,
									onClick: () => setOpenId(open ? null : it.id),
									children: open ? "收起 ↑" : "查看证据 ↓"
								})
							]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							"data-whale-report-improvenums": true,
							children: metrics.map((m) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: m.key === "failureRate" || m.key === "peakRatio" || m.key === "nightPct" ? `${m.value}%` : m.value }), m.label] }, m.key))
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							"data-whale-report-improverec": true,
							children: ["建议 · ", it.recommendation]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ApplyFlow, { item: it }),
						open && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							"data-whale-report-improvedetail": true,
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									"data-whale-report-improverow": true,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "WHY" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: it.summary })]
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									"data-whale-report-improverow": true,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "AFFECTED" }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
										it.evidence.affectedTools.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
											"工具 ",
											it.evidence.affectedTools.join(" / "),
											" · "
										] }),
										"会话 ",
										it.evidence.occurrences,
										" 个",
										it.evidence.affectedSessions.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
											" ",
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", {
												"data-whale-report-improvesid": true,
												children: it.evidence.affectedSessions.slice(0, 4).join(" · ")
											}),
											it.evidence.affectedSessions.length > 4 && ` +${it.evidence.affectedSessions.length - 4}`
										] }),
										it.evidence.confidence > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
											" · 置信度 ",
											(it.evidence.confidence * 100).toFixed(0),
											"%"
										] })
									] })]
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									"data-whale-report-improverow": true,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "VERIFY" }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
										it.verificationPlan.targetMetric,
										" 基线 ",
										it.verificationPlan.baseline ?? "—",
										" → 目标 ",
										it.verificationPlan.target,
										" · ",
...
//#endregion
exports.WhaleContent = WhaleContent;
exports.apply = apply;

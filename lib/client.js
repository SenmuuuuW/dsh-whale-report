...
function green(level) {
	const boosted = Math.pow(Math.min(1, Math.max(0, level)), .55);
	const mix = (from, to) => Math.round(from + (to - from) * boosted);
	const r = mix(222, 77);
	const g = mix(236, 107);
	const b = mix(246, 254);
	if (boosted > .88) return `rgb(${Math.round(r * .72)},${Math.round(g * 1.06)},${Math.round(b * .94)})`;
	return `rgb(${r},${g},${b})`;
}
/** 图例：少 → 多。 */
function Legend() {
...
function SquareRow({ label, cells }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			...
			"data-whale-report-scanwrap": true,
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", {
				"data-whale-report-scanline": true,
				"aria-hidden": "true"
			}), cells.map((c, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", {
				title: c.title,
...
function TrendChart({ label, values, color, unit, keys, liveLast }) {
	...
	const range = Math.max(max - min, max * .2, 1);
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: label }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
					fmt(last),
					unit,
					liveLast === true && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("em", {
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("line", {
					...
					stroke: color,
					strokeWidth: "1.8",
					strokeDasharray: liveLast === true && i === lastIdx ? "3 3" : void 0
				}), liveLast === true && i === lastIdx ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("circle", {
					cx: x,
					cy: y,
					r: "2.6",
					fill: "var(--dt-paper-deep)",
					stroke: color,
					strokeWidth: "1.4"
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				"data-whale-report-trendkeys": true,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: keys[0] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: liveLast === true ? `${keys[keys.length - 1]} · LIVE` : keys[keys.length - 1] })]
			})
		]
	});
}
function TrendSection({ preset }) {
	...
	const chart = (label, values, color, unit) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TrendChart, {
		label,
		values,
		color,
		unit,

	...
	(0, react.useEffect)(() => {
		...
		const timer = window.setInterval(() => {
			...
			if (cur !== prev) {
				setPeriod(cur);
				setNoticed(true);
				window.setTimeout(() => setNoticed(false), 5e3);
			}
			prev = cur;
		}, 6e4);
		...
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					children: "CURRENT RATE / 当前价格"
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("em", {
					"data-whale-report-priceperiod": true,
					children: peak ? "高峰时段 · PEAK" : "空闲时段 · OFF-PEAK"
				})]
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				"data-whale-report-priceval": true,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: peak ? "¥27.0" : "¥13.5" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "V4 Pro 输出 / 百万 token" })]
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				"data-whale-report-pricedetail": true,
				children: "高峰 9:00–12:00 · 14:00–18:00（北京时间）· 空闲半价"
			}),
			noticed && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				"data-whale-report-pricenotice": true,
				children: peak ? "已进入高峰时段，输出价 ¥27.0/百万 token" : "已切换到空闲时段，输出价 ¥13.5/百万 token"
			})
		]
	});
}

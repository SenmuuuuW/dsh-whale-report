...
function ReportView({ report, onDelete }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
		...
		/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ActivityGrid, { series: s.dayHourSeries ?? [] }),
		/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			"data-whale-report-tokenline": true,
			children: [
				"活跃 ",
		...
		danger.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			...
			shownDanger.map((d, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			danger.length > 5 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {

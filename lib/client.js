...
function green(level) {
	...
	const alpha = .2 + boosted * .8;
	return boosted > .72 ? `rgba(54,185,209,${alpha.toFixed(2)})` : `rgba(77,107,254,${alpha.toFixed(2)})`;
}
/** 图例：少 → 多。 */
function Legend() {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			...
			children: cells.map((c, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", {
				title: c.title,
				style: { background: c.level === 0 ? "#dce7ec" : green(c.level) }
			}, i))
		})]
	});
}
...
function TokenBar({ tokens }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", { style: { background: "#9aaaba" } }),
				"缓存 ",
				fmt(tokens.cacheRead)
			] }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", { style: { background: "#0b1733" } }),
				"思考 ",
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: insight.title }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: open ? "CLOSE" : "OPEN" })]
		...
		children: [
			...
			(() => {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SectionHeader, {
					...
					}), collab.map((item) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: ["观察：", item.observation]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								"data-whale-report-collabtip": true,
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: "建议" }),
									"：",
									item.suggestion
								]
							})
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							topTools.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: toolFamilies(s.toolCalls ?? {}).map((fam) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									"data-whale-report-toolrow": true,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", { children: fam.family }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: fam.count })]
								}, fam.family))
							}),
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				style: {
					...
					marginTop: 34,
					paddingTop: 12,
					borderTop: "1px solid var(--dt-line)"
				},
				className: "muted",
				children: [
					report.reportGeneration !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						"data-whale-report-repmeta": true,
						children: [
							"REPORT GENERATION · ",
							fmt(report.reportGeneration.totalTokens),
							" TOKENS ·",
							" ",
							report.reportGeneration.mode === "local" ? "LOCAL DETERMINISTIC" : `MODEL${report.reportGeneration.model !== void 0 ? ` · ${report.reportGeneration.model}` : ""}`
						]
					}),
					"BASED ON ",
					s.totalEvents,
					" SESSION EVENTS · READ ONLY · GENERATED ",
...
function ProviderBalanceCard() {
	...
	const liveTime = data !== null ? new Date(data.checkedAt).toLocaleTimeString("zh-CN", {
		hour: "2-digit",
		minute: "2-digit"
	}) : "——";
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					children: "PROVIDER BALANCE / 模型余额"
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					children: data === null ? "CONNECTING…" : `${BALANCE_STATUS_LABEL[data.status]} · ${data.status.toUpperCase()}`
				})]
			}),
			data !== null && data.status === "connected" && data.balance !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				"data-whale-report-balanceval": true,
				children: [money(data.balance.total), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("small", { children: [data.balance.currency, data.isAvailable === false ? " · 余额不足" : ""] })]
			}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				"data-whale-report-balanceval": true,
				children: ["—", /* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", { children: data === null ? "CONNECTING" : data.error ?? "UNAVAILABLE" })]
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
					...
					liveTime,
					" · READ ONLY"
				] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "KEY NEVER LEAVES LOCAL HOST" })]
			})
		]
	});
}
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							"aria-hidden": "true",
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "CONTEXT ONLINE" }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "THINKING / READY" }),

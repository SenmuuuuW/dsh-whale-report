...
var WhaleContent = class extends react.Component {
	...
	*/
	async refreshOverview(preset) {
		...
		try {
			const response = await fetchWithTimeout(`/whale/api/overview?preset=${encodeURIComponent(preset)}`, {}, FETCH_TIMEOUT_MS.overview, this.requestAbort.signal);
			const body = await response.json();
			if (!response.ok || body.ok === false) throw new Error("overview 读取失败");
			if (seq !== this.requestSeq) return;
			if (body.snapshot === true && body.report !== void 0) {
				this.setState({
				...
				if (age >= SNAPSHOT_FRESH_MS) this.loadDashboard(preset, { background: true });
			} else this.loadDashboard(preset, {});
		} catch (error) {
			if (seq !== this.requestSeq) return;
			this.loadDashboard(preset, {});
		}
	}
				...
				snapshotAt !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							children: snapshotMode ? "LAST COMPLETED SNAPSHOT" : "LAST UPDATED"
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							"data-whale-report-snaptime": true,
							children: new Date(snapshotAt).toLocaleTimeString("zh-CN", { hour12: false })
						}),
						snapshotMode ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							"data-whale-report-snapnote": true,
							children: "数字截至快照时刻 · 快照后实时活动见 LIVE SESSION"
						}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							"data-whale-report-snapnote": true,
							children: "完整统计（含进行中会话）"
						}),
						staleNotice && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {

...
function ReportView({ report, onDelete }) {
    ...
    return (_jsxs("div", { "data-whale-report-report": true, children: [_jsxs("header", { "data-whale-report-reportopening": true, children: [_jsx("img", { src: "/whale/assets/whale-hero.svg", alt: "", "data-whale-report-reporthero": true, onError: (e) => { e.target.style.display = "none"; } }), _jsxs("div", { "data-whale-report-headrow": true, children: [_jsxs("div", { children: [_jsxs("div", { "data-whale-report-reportlabel": true, children: [traceCode(report.preset, report.to), " / AGENT RESEARCH REPORT"] }), _jsxs("div", { "data-whale-report-reptitle": true, children: ["\u6DF1\u8FF9 ", PRESETS.find((p) => p.key === report.preset)?.label ?? "报告"] }), _jsxs("div", { "data-whale-report-repsub": true, children: [dateStr(report.from), " \u2014 ", dateStr(report.to), " / CONTEXT ONLINE"] })] }), _jsxs("div", { "data-whale-report-actions": true, children: [_jsx("button", { "data-whale-report-btn": true, "data-ghost": "true", onClick: () => onDelete(report.id), children: "\u5220\u9664" }), _jsx("button", { "data-whale-report-btn": true, "data-ghost": "true", onClick: () => {
                ...
                if (collab.length === 0)
                    return null;
                return (_jsxs("section", { "data-whale-report-reportsection": true, children: [_jsx(SectionHeader, { index: "03", title: "\u534F\u4F5C\u590D\u76D8", meta: "HUMAN \u00D7 HARNESS / COLLABORATION REVIEW" }), collab.map((item) => (_jsxs("div", { "data-whale-report-collab": true, children: [_jsx("div", { "data-whale-report-collabcode": true, children: item.code }), _jsx("div", { "data-whale-report-collabtitle": true, children: item.title }), _jsxs("div", { "data-whale-report-collabobs": true, children: ["\u89C2\u5BDF\uFF1A", item.observation] }), _jsxs("div", { "data-whale-report-collabtip": true, children: [_jsx("b", { children: "\u5EFA\u8BAE" }), "\uFF1A", item.suggestion] })] }, item.code)))] }));
                            ...
                            })()] })] }), (s.sessionsDetail ?? []).length > 0 && (_jsx(SessionDrilldown, { sessions: s.sessionsDetail ?? [], totalCost: report.cost?.total, index: "07" })), (s.titles ?? []).length > 0 && (_jsxs("section", { "data-whale-report-reportsection": true, children: [_jsx(SectionHeader, { index: "08", title: "\u4F1A\u8BDD\u7D22\u5F15", meta: "APPENDIX / TITLES" }), _jsx("ul", { "data-whale-report-titles": true, children: s.titles.slice(0, 8).map((t) => _jsx("li", { children: t }, t)) })] })), _jsxs("div", { "data-whale-report-tokenline": true, style: { fontSize: 10, marginTop: 34, paddingTop: 12, borderTop: "1px solid var(--dt-line)" }, className: "muted", children: [report.reportGeneration !== undefined && (_jsxs("div", { "data-whale-report-repmeta": true, children: ["REPORT GENERATION \u00B7 ", fmt(report.reportGeneration.totalTokens), " TOKENS \u00B7", " ", report.reportGeneration.mode === "local" ? "LOCAL DETERMINISTIC" : `MODEL${report.reportGeneration.model !== undefined ? ` · ${report.reportGeneration.model}` : ""}`] })), "BASED ON ", s.totalEvents, " SESSION EVENTS \u00B7 READ ONLY \u00B7 GENERATED ", dateStr(report.createdAt)] })] }));
}
...
function ProviderBalanceCard() {
    ...
    return (_jsxs("div", { "data-whale-report-balance": true, children: [_jsxs("div", { "data-whale-report-balancehead": true, children: [_jsx("span", { "data-whale-report-balancelabel": true, children: "PROVIDER BALANCE / \u6A21\u578B\u4F59\u989D" }), _jsx("button", { "data-whale-report-balancebtn": true, "data-live": !loading, disabled: loading, onClick: () => load(true), children: loading ? "检查中…" : "刷新" })] }), _jsxs("div", { "data-whale-report-balancehead": true, style: { marginTop: 5 }, children: [_jsx("span", { "data-whale-report-balancename": true, children: data?.name ?? "DeepSeek" }), _jsx("span", { "data-whale-report-balancestatus": true, children: data === null ? "CONNECTING…" : `${BALANCE_STATUS_LABEL[data.status]} · ${data.status.toUpperCase()}` })] }), data !== null && data.status === "connected" && data.balance !== undefined ? (_jsxs(_Fragment, { children: [_jsxs("div", { "data-whale-report-balanceval": true, children: [money(data.balance.total), _jsxs("small", { children: [data.balance.currency, data.isAvailable === false ? " · 余额不足" : ""] })] }), _jsxs("div", { "data-whale-report-balancebreak": true, children: ["\u5145\u503C\u4F59\u989D ", money(data.balance.toppedUp), " \u00B7 \u8D60\u9001\u4F59\u989D ", money(data.balance.granted)] })] })) : (_jsxs("div", { "data-whale-report-balanceval": true, children: ["\u2014", _jsx("small", { children: data === null ? "CONNECTING" : (data.error ?? "UNAVAILABLE") })] })), _jsxs("div", { "data-whale-report-balancefoot": true, children: [_jsxs("span", { children: ["LIVE \u00B7 ", liveTime, " \u00B7 READ ONLY"] }), _jsx("span", { children: "KEY NEVER LEAVES LOCAL HOST" })] })] }));
}

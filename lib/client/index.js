...
function triggerNotes(report) {
    ...
    if (typeof report.cost?.total === "number" && typeof report.budget === "number" && report.budget > 0) {
        ...
        if (ratio >= 1)
            hits.push({ kind: "budget", weight: 0 });
        else if (ratio >= 0.8)
            hits.push({ kind: "budget", weight: 2 });
    }
...
function WhaleNote({ report }) {
    ...
    const top = kinds[0];
    return (_jsxs("div", { "data-whale-report-card": true, "data-whale-report-note": true, children: [_jsxs("div", { "data-whale-report-notehead": true, children: [_jsx(WhaleFace, { mood: mood, size: 40 }), _jsxs("div", { "data-whale-report-notetitle": true, children: [_jsx("b", { children: "\u672C\u671F\u9CB8\u8BC4" }), _jsxs("span", { "data-whale-report-noteopts": true, children: [_jsx("button", { "data-active": mode === "light", onClick: () => setMode("light"), children: "\u8F7B" }), _jsx("button", { "data-active": mode === "spicy", onClick: () => setMode("spicy"), children: "\u6BD2\u820C" })] })] })] }), top !== undefined && (_jsxs("div", { "data-whale-report-noteline": true, children: ["\u201C", NOTE_TEMPLATES[top][mode], "\u201D"] })), kinds.slice(1, 3).map((kind) => (_jsxs("div", { "data-whale-report-notemore": true, children: ["\u00B7 ", NOTE_TEMPLATES[kind][mode]] }, kind))), kinds.length === 0 && (_jsx("div", { "data-whale-report-noteline": true, children: "\u201C\u672C\u5468\u6570\u636E\u5F88\u5065\u5EB7\uFF0C\u7EE7\u7EED\u4FDD\u6301\u5C31\u597D\u5566\u3002\u201D" })), _jsx("div", { "data-whale-report-notefoot": true, children: "\u57FA\u4E8E\u672C\u671F\u4F7F\u7528\u6570\u636E\u81EA\u52A8\u751F\u6210\u7684\u98CE\u5473\u8BC4\u8BBA\uFF0C\u4E0D\u5F71\u54CD\u6B63\u5F0F\u62A5\u544A\u7ED3\u8BBA\u3002" }), mood === "angry" && _jsx("div", { "data-whale-report-notemore": true, children: "\uFF08\u9CB8\u9C7C\u5A18\u73B0\u5728\u6709\u70B9\u751F\u6C14\uFF0C\u6CE8\u610F\u5B89\u5168\u64CD\u4F5C\u3002\uFF09" })] }));
}
/** 声呐图标（会话钻取/活跃 的分区装饰）。 */

...
function PartialBanner({ partial }) {
    if (partial === undefined || partial.skippedCount <= 0)
        return null;
    const shown = partial.skippedSessionIds.slice(0, 4);
    return (_jsxs("div", { "data-whale-report-partial": true, role: "note", children: [_jsx("span", { "data-whale-report-partialmark": true, children: "DATA PARTIAL" }), _jsxs("span", { children: [_jsx("b", { children: partial.skippedCount }), " \u4E2A\u4F1A\u8BDD\u65E5\u5FD7\u635F\u574F/\u65E0\u6CD5\u8BFB\u53D6\uFF0C\u5DF2\u8DF3\u8FC7", shown.length > 0 && (_jsxs(_Fragment, { children: [" ", _jsx("code", { children: shown.join(" · ") }), shown.length < partial.skippedCount && ` +${partial.skippedCount - shown.length}`] })), "\u3002\u4EE5\u4E0B\u6570\u5B57\u4F4E\u4E8E\u5B9E\u9645\u4E14\u4E0D\u6309 0 \u8BA1\uFF0C\u53EF\u5728 ~/.dsh \u4E2D\u6838\u67E5\u88AB\u8DF3\u8FC7\u7684\u4F1A\u8BDD\u3002"] })] }));
}

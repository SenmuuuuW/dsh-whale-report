...
function ReportView({ report, onDelete }) {
    ...
    return (_jsxs("div", { children: [_jsxs("div", { "data-whale-report-actions": true, children: [_jsx("button", { "data-whale-report-btn": true, onClick: exportPdf, children: "\u5BFC\u51FA PDF" }), _jsx("button", { "data-whale-report-btn": true, "data-ghost": "true", onClick: () => onDelete(report.id), children: "\u5220\u9664" })] }), _jsxs("div", { "data-whale-report-hero": true, children: [_jsxs("div", { "data-whale-report-herotitle": true, children: ["\u6DF1\u8FF9 ", PRESETS.find((p) => p.key === report.preset)?.label ?? "报告"] }), _jsxs("div", { "data-whale-report-herosub": true, children: [dateStr(report.from), " ~ ", dateStr(report.to)] }), _jsxs("div", { "data-whale-report-herostat": true, children: [_jsxs("div", { children: [_jsx("b", { children: s.sessions }), _jsx("span", { children: "\u4F1A\u8BDD" })] }), _jsxs("div", { children: [_jsx("b", { children: s.turns }), _jsx("span", { children: "\u56DE\u5408" })] }), _jsxs("div", { children: [_jsx("b", { children: fmt(s.toolCallsTotal) }), _jsx("span", { children: "\u5DE5\u5177\u8C03\u7528" })] }), _jsxs("div", { children: [_jsx("b", { children: fmt(s.commands) }), _jsx("span", { children: "\u547D\u4EE4" })] }), _jsxs("div", { children: [_jsx("b", { children: fmt(totalTokens) }), _jsx("span", { children: "Token" })] }), typeof report.cost?.total === "number" && (_jsxs("div", { children: [_jsxs("b", { children: ["\u00A5", report.cost.total.toFixed(2)] }), _jsx("span", { children: "\u9884\u4F30\u8D39\u7528" })] }))] }), delta !== null && (_jsxs("div", { "data-whale-report-herodelta": true, children: [_jsx("span", { children: "\u8F83\u4E0A\u5468\u671F\u8D39\u7528" }), _jsxs("b", { style: { color: delta > 0 ? "#fca5a5" : "#86efac" }, children: [delta > 0 ? "▲" : "▼", " ", Math.abs(delta), "%"] }), _jsxs("span", { className: "muted", children: ["\uFF08\u00A5", report.prev.cost.toFixed(2), " \u2192 \u00A5", report.cost.total.toFixed(2), "\uFF09"] })] })), budgetUsed !== null && (_jsxs("div", { "data-whale-report-budget": true, children: [_jsx("div", { "data-whale-report-budgetbar": true, children: _jsx("i", { style: { width: `${budgetUsed * 100}%`, background: budgetUsed >= 1 ? "#dc2626" : budgetUsed >= 0.8 ? "#d97706" : "#86efac" } }) }), _jsxs("span", { children: ["\u5468\u9884\u7B97 \u00A5", report.budget.toFixed(2), " \u00B7 \u5DF2\u7528 ", (budgetUsed * 100).toFixed(0), "%", budgetUsed >= 1 ? "（已超支）" : ""] })] }))] }), _jsx(InsightsSection, { insights: report.insights ?? [] }), _jsxs("div", { "data-whale-report-card": true, children: [_jsxs("div", { "data-whale-report-h2": true, children: ["\u6D3B\u8DC3\u65F6\u6BB5\uFF08\u51CC\u6668 ", night, "%\uFF09"] }), _jsx(ActivityStrip, { report: report }), _jsxs("div", { "data-whale-report-tokenline": true, children: ["\u6D3B\u8DC3 ", s.activeDays, " \u5929", s.busiestDay ? _jsxs(_Fragment, { children: [" \u00B7 \u6700\u5FD9 ", _jsx("b", { children: s.busiestDay.date }), "\uFF08", s.busiestDay.events, " \u6761\u4E8B\u4EF6\uFF09"] }) : null] })] }), _jsxs("div", { "data-whale-report-card": true, children: [_jsx("div", { "data-whale-report-h2": true, children: "Token \u6784\u6210" }), _jsx(TokenBar, { tokens: s.tokens })] }), _jsxs("div", { "data-whale-report-card": true, children: [_jsx("div", { "data-whale-report-h2": true, children: "\u6A21\u578B\u7528\u91CF\uFF08DeepSeek \u5B98\u65B9\u8BA1\u4EF7\uFF09" }), _jsx(ModelTable, { models: s.models ?? {}, cost: report.cost }), typeof report.cost?.total === "number" && report.cost.total > 0 && (_jsxs("div", { "data-whale-report-tokenline": true, style: { marginTop: 8 }, children: ["\u9884\u4F30\u5408\u8BA1 ", _jsxs("b", { children: ["\u00A5", report.cost.total.toFixed(2)] }), _jsxs("span", { className: "muted", children: [" \u00B7 ", report.cost.source === "official-page" ? "官方定价页实时价" : "内置价", " \u00B7 \u4EE5\u5E73\u53F0\u8D26\u5355\u4E3A\u51C6"] })] }))] }), _jsxs("div", { "data-whale-report-card": true, children: [_jsx("div", { "data-whale-report-h2": true, children: "\u5DE5\u5177\u4F7F\u7528\uFF08\u6309\u65CF\uFF09" }), toolFamilies(s.toolCalls ?? {}).length === 0 ? (_jsx("div", { "data-whale-report-tokenline": true, children: "\uFF08\u6CA1\u6709\u8C03\u7528\u5DE5\u5177\uFF09" })) : (toolFamilies(s.toolCalls ?? {}).map((fam) => (_jsxs("div", { "data-whale-report-tokenline": true, children: [_jsx("code", { children: fam.family }), " \u00D7 ", fam.count] }, fam.family))))] }), (s.burstSamples ?? []).length > 0 && (() => {
                ...
                return (_jsxs("div", { "data-whale-report-card": true, children: [_jsxs("div", { "data-whale-report-h2": true, children: ["\u91CD\u8BD5\u8BCA\u65AD\uFF08", bursts.length, "\uFF09"] }), bursts.map((b, i) => (_jsxs("div", { "data-whale-report-danger": true, "data-sev": "amber", children: [b.cmd, _jsxs("em", { children: ["\u91CD\u590D ", b.count, " \u6B21 \u00B7 ", new Date(b.time).toISOString().slice(0, 16).replace("T", " "), b.error !== undefined ? _jsxs(_Fragment, { children: [" \u00B7 \u9519\u8BEF\uFF1A", b.error.slice(0, 90)] }) : null] })] }, i)))] }));

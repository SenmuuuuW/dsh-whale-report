...
function ActivityGrid({ series }) {
    ...
    return (_jsxs("div", { "data-whale-report-gridwrap": true, children: [_jsxs("div", { "data-whale-report-grid": true, children: [_jsx("div", { "data-whale-report-gridhours": true, children: Array.from({ length: 24 }, (_, h) => (_jsx("span", { children: hourLabels.includes(String(h).padStart(2, "0")) ? String(h).padStart(2, "0") : "" }, h))) }), shown.map((day) => (_jsx("div", { "data-whale-report-gridcol": true, children: day.hours.map((count, h) => (_jsx("i", { title: `${day.date} ${String(h).padStart(2, "0")}:00 · ${count} 事件`, style: { background: hue(count) } }, h))) }, day.date)))] }), _jsx("div", { "data-whale-report-griddates": true, children: shown.map((day) => (_jsx("span", { children: day.date.slice(5) }, day.date))) })] }));
}

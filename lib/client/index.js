...
function TokenBar({ tokens }) {
    ...
    return (_jsxs("div", { children: [_jsxs("div", { "data-whale-report-tokenbar": true, children: [seg(tokens.input, "#4d6bfe", "输入"), seg(tokens.output, "#36b9d1", "输出"), seg(tokens.cacheRead, "#aec0d8", "缓存命中"), seg(tokens.reasoning, "#26406e", "思考")] }), _jsxs("div", { "data-whale-report-tokenlegend": true, children: [_jsxs("span", { children: [_jsx("i", { style: { background: "#4d6bfe" } }), "\u8F93\u5165 ", fmt(tokens.input)] }), _jsxs("span", { children: [_jsx("i", { style: { background: "#36b9d1" } }), "\u8F93\u51FA ", fmt(tokens.output)] }), _jsxs("span", { children: [_jsx("i", { style: { background: "#aec0d8" } }), "\u7F13\u5B58 ", fmt(tokens.cacheRead)] }), _jsxs("span", { children: [_jsx("i", { style: { background: "#26406e" } }), "\u601D\u8003 ", fmt(tokens.reasoning)] })] })] }));
}
...
function ReportView({ report, onDelete }) {
    ...
    const delta = report.prev !== undefined && report.prev.cost > 0 && typeof report.cost?.total === "number"
        ...
        : null;
    return (_jsxs("div", { "data-whale-report-report": true, children: [_jsxs("header", { "data-whale-report-reportopening": true, children: [_jsx("img", { src: "/whale/assets/whale-hero.svg", alt: "", "data-whale-report-reporthero": true, onError: (e) => { e.target.style.display = "none"; } }), _jsxs("div", { "data-whale-report-headrow": true, children: [_jsxs("div", { children: [_jsxs("div", { "data-whale-report-reportlabel": true, children: [traceCode(report.preset, report.to), " / AGENT RESEARCH REPORT"] }), _jsxs("div", { "data-whale-report-reptitle": true, children: ["\u6DF1\u8FF9 ", PRESETS.find((p) => p.key === report.preset)?.label ?? "报告"] }), _jsxs("div", { "data-whale-report-repsub": true, children: [dateStr(report.from), " \u2014 ", dateStr(report.to), " / CONTEXT ONLINE"] })] }), _jsxs("div", { "data-whale-report-actions": true, children: [_jsxs("button", { "data-whale-report-btn": true, onClick: () => setExportOpen(!exportOpen), "aria-expanded": exportOpen, children: ["EXPORT ", exportOpen ? "↑" : "↓"] }), _jsx("i", { "aria-hidden": "true" }), _jsx("button", { "data-whale-report-danger-action": true, onClick: () => onDelete(report.id), children: "\u5220\u9664\u62A5\u544A" })] })] }), exportOpen && (_jsxs("div", { "data-whale-report-exportmenu": true, children: [_jsxs("button", { onClick: () => {
...
function TrendSection({ preset }) {
    ...
    return (_jsxs("section", { "data-whale-report-section": true, children: [_jsx(SectionHeader, { index: "\u2014", title: "\u5386\u53F2\u8D8B\u52BF", meta: `HISTORY / ${completeCount} COMPLETE${liveCount > 0 ? ` · ${liveCount} LIVE` : ""}` }), _jsxs("div", { "data-whale-report-trendgrid": true, children: [chart("成本", (t) => t.cost, "var(--dt-blue)", "¥"), chart("会话", (t) => t.sessions, "var(--dt-cyan)", ""), chart("缓存命中", (t) => t.cacheHitRate, "var(--dt-safe, #31765a)", "%"), chart("夜间活跃", (t) => t.nightRatio, "var(--dt-amber)", "%")] })] }));
}
...
function PricePeriodCard() {
    ...
    return (_jsxs("div", { "data-whale-report-price": true, "data-period": period, children: [_jsxs("div", { "data-whale-report-pricehead": true, children: [_jsx("span", { "data-whale-report-pricecode": true, children: "CURRENT RATE / \u5F53\u524D\u4EF7\u683C" }), _jsx("em", { "data-whale-report-priceperiod": true, children: peak ? "高峰时段 · PEAK" : "空闲时段 · OFF-PEAK" })] }), _jsxs("div", { "data-whale-report-priceval": true, children: [_jsx("b", { children: peak ? "¥27.0" : "¥13.5" }), _jsx("span", { children: "V4 Pro \u8F93\u51FA / \u767E\u4E07 token" })] }), _jsx("div", { "data-whale-report-pricedetail": true, children: "\u9AD8\u5CF0 9:00\u201312:00 \u00B7 14:00\u201318:00\uFF08\u5317\u4EAC\u65F6\u95F4\uFF09\u00B7 \u7A7A\u95F2\u534A\u4EF7" }), noticed && (_jsx("div", { "data-whale-report-pricenotice": true, children: peak ? "已进入高峰时段，输出价 ¥27.0/百万 token" : "已切换到空闲时段，输出价 ¥13.5/百万 token" }))] }));
}

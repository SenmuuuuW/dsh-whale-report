...
export const whaleDomain = defineDomain({
    ...
    tables: {
        ...
        period_stats: domainTable(PeriodStatsSchema),
        apply_proposals: domainTable(ApplyProposalSchema),
        apply_records: domainTable(ApplyRecordSchema),
        verify_records: domainTable(VerifyRecordSchema),
        audit_log: domainTable(AuditEventSchema),
    },
});

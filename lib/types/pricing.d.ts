 ...
 */
export declare const WEEKEND_OFFPEAK_EFFECTIVE_AT: number;
/**
 ...
 */
export declare function pricingTierForTime(ms: number): PricingTier;
/** 当前时刻价格（峰/谷）。 */
...
export declare function computeCostTimed(perTimeModelTokens: {
    time: number;
